$(document).ready(function() {var formatter = new CucumberHTML.DOMFormatter($('.cucumber-report'));formatter.uri("file:src/test/resources/main/resources/feature/OpenCart.feature");
formatter.feature({
...
formatter.step({
  "name": "I enter login details from Excel \"src/test/resources/ExcelSheet/OpenCart.xlsx\" with SheetName \"ValidCredentials\"",
  "keyword": "When "
});
formatter.match({
  "location": "com.cts.stepdefintion.StepDefinition.i_enter_login_details_from_Excel_with_SheetName(java.lang.String,java.lang.String)"
});
formatter.result({
  "status": "passed"
});
